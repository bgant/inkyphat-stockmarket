...
print('price:'.rjust(9),   test1.price().rjust(10))
print('percent:'.rjust(9), test1.percent().rjust(10))
print('day:'.rjust(9),     test1.day().rjust(10))
...
print('price:'.rjust(9),   test2.price().rjust(10))
print('percent:'.rjust(9), test2.percent().rjust(10))
print('day:'.rjust(9),     test2.day().rjust(10))
print('status:'.rjust(9),  str(test2.status()).rjust(10))
